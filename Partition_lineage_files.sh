...
declare -a array=( $(ls ./03_Codon_aligned_noHXB2/*V703*noHXB2*lineages.fasta) ) #searches current directory for fasta files and add their names to an array
arraylength=${#array[@]}
